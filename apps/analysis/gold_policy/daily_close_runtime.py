...
def execute_gold_daily_close_runtime(
    *,
    ...
    bundle_path = storage_root / "analysis" / "gold_mainlines" / session_date.isoformat() / run_id / "daily_close"
    ...
    if (
        ...
        raise DailyCloseHeadConflictError("current feature must be newer than the durable canonical head")
