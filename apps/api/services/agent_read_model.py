...
def _compact_agent(item: dict[str, Any] | None) -> dict[str, Any] | None:
    ...
    return {
        ...
        "invalidation_conditions": item.get("invalidation_conditions") or item.get("invalid_conditions") or [],
        "active_blockers": item.get("active_blockers") or [],
        "data_gaps": item.get("data_gaps") or [],
        "review_triggers": item.get("review_triggers") or [],
