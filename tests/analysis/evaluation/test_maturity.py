...
@pytest.mark.parametrize(
    ...
    [
        ...
        ({"entry_conditions": [], "invalidation": {}}, "evaluation_setup_missing"),
    ],
)
...
def test_reference_price_is_not_required_when_fill_contract_is_complete() -> None:
    plan = build_outcome_maturity_plan(
    ...
    assert one_hour.outcome.fill_price == 100.5
