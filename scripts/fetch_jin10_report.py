...
def _apply_category_override(report, category_code: str):
    ...
    if classification.category_code not in {"271", "272", "274", "301", "458"}:
        return report
    return replace(report, report_type=classification.report_type, category=classification.category)
